                ...
                <div class="card shadow-lg">
                    ...
                    <div class="card-body">
                        <div class="text-center mb-4">
                            <img src="{{ asset('images/mascota-tortuga.png') }}" alt="Mascota Trivia" class="img-fluid mb-3"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="category" id="category" class="form-select">
                                            ...
                                            @php
                                                $categoriasNinos = ['9', '10', '15', '27', '28', '32'];
                                            @endphp
                                            @foreach ($categories as $category)
                                                @if (in_array($category['id'], $categoriasNinos))
                        ...
                        <div class="row mt-4">
                            <div class="col-12">
                                <div class="alert alert-info">
                                    ...
                                    <p class="mb-0">Selecciona la categoría, dificultad y tipo de preguntas que deseas,
                                        luego haz clic en "Crear Quiz" para comenzar. ¡Pon a prueba tus conocimientos y
                                        diviértete aprendiendo!</p>
                                </div>
                            </div>
                        </div>
                    </div>
